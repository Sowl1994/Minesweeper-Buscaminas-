...
class CampoMinas{
  ...
  public:
     /**
      * @brief Constructor
      * @param fila int que es la fila de la casilla 
      * @param columna int que es la columna de la casilla 
      * @param nMinas int que es el numero de minas 
      */
    CampoMinas(int f, int c, int nMinas);
  ...
  /**
    ...
    */
    ...
    /**
      ...
      *
      */
    bool marcarCasilla(int fila, int columna);
    ...
    /**
      ...
      * @param a Parametro que por defecto toma el valor de cout
      *
      */
